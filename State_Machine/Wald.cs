    ...
    internal class Wald : RoomBaseState
    {
        ...
        public override void UpdateState()
        {
            if (Console.KeyAvailable)
            {
                ...
                {
                    TextAnimate("Du beschwörst eine Taschenlampe!");
                }
            }
        }
        ...
        {
            TextAnimate("Du verlässt den Wald!");
        }
